const { ownsAllInSet } = require('../../flow/scripts/nflallday.js');
...
module.exports = {
    name: 'button-verifyAllMomentsInSetAllDay',
    description: 'verifies if a user has all the moments from a set in nfl all day',
    execute,
}